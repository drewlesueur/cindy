...
*/
 ...
 "<font color = '#ffffff' size = '25'><a href = 'http://regulus2.azstarnet.com/blogs/mycountry/11488/a-twang-filled-end-to-su'>A twang-filled end to summer '08" + "\n" +
...
*/
        ...
        if (page == "about")
        {
          ...
          about_index = so.data.about_index || 0;
        ...
        if (page == "tours")
        {
          ...
          tours_index = so.data.tours_index || 0;
        ...
        if (page == "press")
        {
          ...
          press_index = so.data.press_index || 0;
...
var bottom_links = function(){
 ...
 /_/    \_\_|\___|_|   \__|  \__|\___/_/\_\ \__|_.__/ \___//_/\_\
		...
		//Alert text box!
		_root.createTextField("alert",_root.getNextHighestDepth(),0,400,100,300);

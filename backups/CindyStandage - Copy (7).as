...
"Feb 10, 2008\nAlan Jackson Tim's Toyota Center\nPrescott Valley\n\n" 
,
...
*/
		...
		{
      if (nav[i].navtext.toLowerCase() == page)
      {
        nav[i].onPress()
        break;
      }
...
var bottom_links = function(){
 ...
 /_/    \_\_|\___|_|   \__|  \__|\___/_/\_\ \__|_.__/ \___//_/\_\
		...
		//Alert text box!
		_root.createTextField("alert",_root.getNextHighestDepth(),0,400,300,300);
